                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form class="">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group"><input name="password" id="examplePassword" placeholder="Nama Lengkap Ibu" type="password" class="form-control"></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer clearfix">
                                        ...
                                        <div class="float-right">
                                            <button class="btn btn-primary btn-lg">Validasi</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
